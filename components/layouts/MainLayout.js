                ...
                <div className="row">
                    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div className="text-center">
                            <h2 className="section-lg-title-light">UNO STAFF DI PROFESSIONISTI A TUA DISPOSIZIONE</h2>
                            <p className="lead banner-para-light">Rimply dummy text of the printing and typesetting
                                industry. Lorem Ipsum has been the industry's standard dummy text ever since printer
                                took a galley.</p>
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div className="footer-box">
                                <h3 className="title-bar-footer">menu.about_us</h3>
                                <ul className="recent-post-link">
                                    <li>
                                        <Link href="/contact"><a>menu.contact</a></Link>
                                    </li>
                                    <li>
                                        <Link href="/security"><a>menu.security</a></Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
