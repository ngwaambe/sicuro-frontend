                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div className="footer-box">
                                        ...
                                        <ul className="recent-post-link">
                                            ...
                                            <li>
                                                <Link href="/services/transfer"><a>{this.props.t('menu-secureDomainTransfer')}</a></Link>
                                            </li>
                                            <li>
                                                <Link href="/services/sellonline"><a>{this.props.t('menu-sellDomainOnline')}</a></Link>
                                            </li>
                                            <li>
                                                <Link href="/services/buyonline"><a>{this.props.t('menu-buyDomainOnline')}</a></Link>
                                            </li>
                                            <li>
                                                <Link href="/services/buynowlink"><a>{this.props.t('menu-buyNowLink')}</a></Link>
                                            </li>
                                            <li>
                                                <Link href="/services/broker"><a>{this.props.t('menu-broker')}</a></Link>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div className="footer-box">
                                        ...
                                        <ul className="recent-post-link">
                                            <li>
                                                <Link href="/terms"><a>{this.props.t('menu-terms_and_conditions')}</a></Link>
                                            </li>
                                            <li>
                                                <Link href="/policy"><a>{this.props.t('menu-privacy_policy')}</a></Link>
                                            </li>
                                            <li>
                                                <Link href="/rules"><a>{this.props.t('menu-transaction_rules')}</a></Link>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
